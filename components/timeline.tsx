...
const Processing = () => {
  ...
  const [stageNamesVisible, setStageNamesVisible] = useState([
    false,
    false,
    false,
    false,
  ]); // Track visibility of each stage name
    ...
    <div className="space-y-6">
      <ol className="relative border-l border-gray-200 dark:border-gray-700">
        ...
        <li className="mb-10 ml-4">
          <div
            className={`absolute w-3 h-3 rounded-full mt-1.5 -left-1.5 border ${getStageClass(
              1
            )}`}
          ></div>
